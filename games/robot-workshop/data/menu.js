...
export const SETTINGS_TEXT = {
  ...
  reset: 'Reset save',
  resetSub: 'Deletes the current run and everything kept across runs',
  reset1Title: 'Reset your save?',
  reset1Body: 'This deletes your current run, finished campaigns, achievements, records and discoveries on this device.',
  reset2Title: 'Really delete everything?',
  reset2Body: 'This cannot be undone.',
  reset2Yes: 'Delete everything',
  resetDone: 'Save reset — starting fresh.',
};
